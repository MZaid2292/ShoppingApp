...
class ZCustomRoundedEdges extends CustomClipper<Path> {
  @override
  Path getClip(Size size) {
    //Size is height & width of container
    Path path = Path();
    ...
    path.quadraticBezierTo(
        firstPointCurve1.dx, firstPointCurve1.dy, secondPointCurve1.dx,
    ...
    path.quadraticBezierTo(
        firstPointCurve2.dx, firstPointCurve2.dy, secondPointCurve2.dx,
