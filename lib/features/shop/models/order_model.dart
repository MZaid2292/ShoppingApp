...
class OrderModel{
  ...
  String get formattedOrderDate => ZHelperFunctions.getFormattedDate(orderDate);

  String get formattedDeliveryDate => ZHelperFunctions.getFormattedDate(deliveryDate!);
