...
class ZDummyData {
  ...
  static final List<BannerModel> banner = [
    BannerModel(
      imageUrl: ZImages.homeBanner1,
      targetScreen: ZRoutes.order,
      active: true,
    ),
    BannerModel(
      imageUrl: ZImages.homeBanner2,
      targetScreen: ZRoutes.cart,
      active: true,
    ),
    BannerModel(
      imageUrl: ZImages.homeBanner3,
      targetScreen: ZRoutes.wishlist,
      active: true,
    ),
    BannerModel(
      imageUrl: ZImages.homeBanner4,
      targetScreen: ZRoutes.productDetail,
      active: true,
    ),
    BannerModel(
      imageUrl: ZImages.homeBanner5,
      targetScreen: ZRoutes.profile,
      active: true,
    ),
  ];
  ...
  static final List<CategoryModel> categories = [
    ...
    CategoryModel(
      id: '1',
      name: 'Clothes',
      image: ZImages.clothesIcon,
      isFeatured: true,
    ),
    CategoryModel(
      id: '2',
      name: 'Shoes',
      image: ZImages.shoesIcon,
      isFeatured: true,
    ),
    CategoryModel(
      id: '3',
      name: 'Cosmetics',
      image: ZImages.cosmeticsIcon,
      isFeatured: true,
    ),
    CategoryModel(
      id: '4',
    ...
    CategoryModel(
      id: '7',
      name: 'Shirts',
      image: ZImages.shirtIcon,
      parentId: '1',
    ),
    CategoryModel(
      id: '8',
      name: 'Jackets',
      image: ZImages.jacketsIcon,
      parentId: '1',
    ),
    CategoryModel(
      id: '9',
      name: 'Shorts',
      image: ZImages.shortsIcon,
      parentId: '1',
    ),
    ...
    CategoryModel(
      id: '10',
      name: 'Formal Shoes',
      image: ZImages.formalShoesIcon,
      parentId: '2',
    ),
    CategoryModel(
      id: '11',
      name: 'Sports Shoes',
      image: ZImages.sportsShoesIcon,
      parentId: '2',
    ),
    ...
    CategoryModel(
      id: '12',
      name: 'Face',
      image: ZImages.faceIcon,
      parentId: '3',
    ),
    CategoryModel(
      id: '13',
      name: 'Hair Oils',
      image: ZImages.hairOilIcon,
      parentId: '3',
    ),
    CategoryModel(
      id: '14',
      name: 'Bags',
      image: ZImages.bagsIcon,
      parentId: '3',
    ),
    CategoryModel(
      id: '15',
      name: 'Perfumes',
      image: ZImages.perfumeIcon,
      parentId: '3',
    ),
    CategoryModel(
      id: '16',
      name: 'Watches',
      image: ZImages.watchIcon,
      parentId: '3',
    ),
  ...
  static final List<BrandModel> brands = [
    BrandModel(
      id: "1",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797013/Brand%20Images/dsbmzqnj9bqzfsondypk.png",
      name: "Nike",
      productsCount: 6,
      isFeatured: true,
    ),
    BrandModel(
      id: "2",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797016/Brand%20Images/qcqilhkrohpelzuuagb6.jpg",
      name: "Adidas",
      productsCount: 7,
      isFeatured: true,
    ),
    BrandModel(
      id: "3",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797017/Brand%20Images/qwic7pkiqm0t1dra3y0b.jpg",
      name: "Apple",
      productsCount: 6,
      isFeatured: true,
    ),
    BrandModel(
      id: "4",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797018/Brand%20Images/t7yspmumngeuzzhfh9fo.png",
      name: "Bata",
      productsCount: 1,
      isFeatured: true,
    ),
    BrandModel(
      id: "5",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797019/Brand%20Images/m4xfkzvzxpnjwa7jrs38.png",
      name: "Blood",
      productsCount: 4,
      isFeatured: false,
    ),
    BrandModel(
      id: "6",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797022/Brand%20Images/l7u5c5ac1mcokujz0u15.jpg",
      name: "Breakout",
      productsCount: 3,
      isFeatured: true,
    ),
    BrandModel(
      id: "7",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797023/Brand%20Images/wjpoyl0dwk32rfpzyxx3.png",
      name: "Dari Moch",
      productsCount: 3,
      isFeatured: true,
    ),
    BrandModel(
      id: "8",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797025/Brand%20Images/kcxex1rbojuvxczwfhqv.jpg",
      name: "Interwood",
      productsCount: 5,
      isFeatured: false,
    ),
    BrandModel(
      id: "9",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797027/Brand%20Images/sdjdoabtv5agunaxm1ag.jpg",
      name: "HP",
      productsCount: 7,
      isFeatured: false,
    ),
    BrandModel(
      id: "10",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797028/Brand%20Images/dkmqfe0niulvheqbevwx.png",
      name: "J",
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: "11",
      image:
          "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797029/Brand%20Images/g5ihbtunif6io0jgfhvl.png",
      name: "NDURE",
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: "12",
      image: "https://res.cloudinary.com/dylut2c5f/image/upload/v1761797030/Brand%20Images/secn3eo3hllv2fmkxn8d.jpg",
      name: "NorthStar",
      productsCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: "13",
      image:"https://res.cloudinary.com/dylut2c5f/image/upload/v1761797031/Brand%20Images/modd72svnzi9hmldn97v.png",
      name: "Polo",
      productsCount: 2,
      isFeatured: true,
    ),
  ...
  static final List<ProductModel> products = [
    ...
    ProductModel(
      ...
      stock: 15,
      price: 115,
      thumbnail: ZImages.productImage1,
      description:
    ...
    ProductModel(
      ...
      price: 30,
      isFeatured: true,
      thumbnail: ZImages.productImage2,
      description:
    ...
    ProductModel(
      ...
      price: 700,
      isFeatured: false,
      thumbnail: ZImages.productImage3,
      description:
    ...
    ProductModel(
      ...
      price: 350,
      isFeatured: true,
      thumbnail: ZImages.productImage4a,
      description:
      ...
      brand: brands[2],
      images: [
        ZImages.productImage4b,
        ZImages.productImage4c,
        ZImages.productImage4d,
        ZImages.productImage4e,
      ],
      sku: 'ABR4568',
      categoryId: '19',
      productAttributes: [
    ...
    ProductModel(
      ...
      price: 60,
      isFeatured: false,
      thumbnail: ZImages.productImage5,
      description:
    ...
    ProductModel(
      ...
      stock: 0,
      price: 50,
      thumbnail: ZImages.productImage6,
      description:
    ...
    ProductModel(
      ...
      price: 70,
      isFeatured: true,
      thumbnail: ZImages.productImage7,
      //16/512
      description:
    ...
    ProductModel(
      ...
      stock: 50,
      price: 55.99,
      thumbnail: ZImages.productImage8,
      description:
    ...
    ProductModel(
      ...
      salePrice: 7.99,
      price: 8.99,
      thumbnail: ZImages.productImage9,
      description:
    ...
    ProductModel(
      ...
      brand: brands[3],
      thumbnail: ZImages.productImage10,
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage11,
      sku: 'BATA-SOCKS',
      categoryId: '9',
      isFeatured: true,
      brand: brands[3],
    ...
    ProductModel(
      ...
      stock: 10,
      price: 4.99,
      thumbnail: ZImages.productImage12,
      description:
    ...
    ProductModel(
      ...
      price: 39.99,
      stock: 23,
      thumbnail: ZImages.productImage13,
      description:
    ...
    ProductModel(
      ...
      stock: 3,
      salePrice: 87.99,
      thumbnail: ZImages.productImage14,
      description:
    ...
    ProductModel(
      ...
      stock: 54,
      salePrice: 47.99,
      thumbnail: ZImages.productImage15,
      description:
    ...
    ProductModel(
      ...
      price: 79.99,
      salePrice: 71.99,
      thumbnail: ZImages.productImage16a,
      images: [ZImages.productImage16b],
      stock: 153,
      description:
    ...
    ProductModel(
      ...
      stock: 19,
      brand: brands[5],
      thumbnail: ZImages.productImage17,
      description:
    ...
    ProductModel(
      ...
      price: 29.99,
      salePrice: 23.99,
      thumbnail: ZImages.productImage18,
      stock: 12,
      brand: brands[5],
      categoryId: '7',
      description:
    ...
    ProductModel(
      ...
      price: 59.99,
      salePrice: 49.99,
      thumbnail: ZImages.productImage19a,
      images: [ZImages.productImage19b],
      stock: 12,
      brand: brands[10],
      categoryId: '10',
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage20,
      price: 44.99,
      salePrice: 39.99,
      stock: 43,
      brand: brands[3],
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage21,
      price: 89.99,
      salePrice: 78.87,
      categoryId: '7',
      brand: brands[1],
    ...
    ProductModel(
      ...
      salePrice: 969.99,
      stock: 2,
      thumbnail: ZImages.productImage22,
      brand: brands[8],
      categoryId: '18',
      productType: 'ProductType.variable',
      description:
    ...
    ProductModel(
      ...
      price: 1099,
      salePrice: 999.99,
      thumbnail: ZImages.productImage23,
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage24,
      price: 59.99,
      salePrice: 48.99,
      stock: 43,
      brand: brands[9],
    ...
    ProductModel(
      ...
      price: 29.99,
      salePrice: 26.99,
      thumbnail: ZImages.productImage25,
      stock: 23,
      brand: brands[5],
      description:
    ...
    ProductModel(
      ...
      price: 49.99,
      salePrice: 44.99,
      thumbnail: ZImages.productImage26,
      stock: 23,
      brand: brands[7],
      description:
    ...
    ProductModel(
      ...
      price: 12.99,
      thumbnail: ZImages.productImage27,
      brand: brands[6],
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage28,
      stock: 3,
      price: 8.99,
      salePrice: 7.76,
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage29,
      stock: 3,
      price: 9.99,
      salePrice: 7.56,
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage30,
      stock: 3,
      price: 29.99,
      salePrice: 27.99,
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage31,
      price: 69.99,
      salePrice: 52.99,
      stock: 2,
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage32,
      price: 499.99,
      salePrice: 475.99,
      stock: 3,
      productType: 'ProductType.variable',
    ...
    ProductModel(
      ...
      price: 849,
      thumbnail: ZImages.productImage33a,
      images: [
        ZImages.productImage33b,
        ZImages.productImage33c,
        ZImages.productImage33d,
      ],
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage34,
      price: 1399.99,
      salePrice: 1268.99,
      stock: 76,
      description:
    ...
    ProductModel(
      ...
      price: 1599,
      thumbnail: ZImages.productImage35,
      salePrice: 1497.99,
      stock: 29,
      description:
    ...
    ProductModel(
      ...
      price: 14.99,
      thumbnail: ZImages.productImage36,
      stock: 3,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage37,
      brand: brands[4],
      categoryId: '17',
      sku: "KEYBOARD-BLOODY",
    ),
    ...
    ProductModel(
      ...
      salePrice: 1133.99,
      stock: 34,
      thumbnail: ZImages.productImage38a,
      images: [ZImages.productImage38b, ZImages.productImage38c],
      productType: 'ProductType.variable',
      categoryId: '18',
      sku: "LAPTOP-HP",
      brand: brands[8],
    ...
    ProductModel(
      ...
      salePrice: 899,
      stock: 2,
      thumbnail: ZImages.productImage39,
      productType: 'ProductType.variable',
      categoryId: '18',
      sku: "LAPTOP-HP",
      brand: brands[8],
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage40,
      productType: 'ProductType.single',
      stock: 2,
      price: 399.99,
      salePrice: 375.99,
    ...
    ProductModel(
      ...
      salePrice: 144.99,
      stock: 22,
      thumbnail: ZImages.productImage41,
      description:
    ...
    ProductModel(
      ...
      price: 179.99,
      thumbnail: ZImages.productImage42,
      stock: 23,
      brand: brands[4],
      description:
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage43,
      stock: 21,
      price: 479.99,
      salePrice: 452.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage44,
      stock: 21,
      price: 49.99,
      productType: 'ProductType.single',
      categoryId: '17',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage45a,
      images: [ZImages.productImage45b],
      stock: 21,
      price: 29.99,
      salePrice: 28.99,
      productType: 'ProductType.variable',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage46,
      stock: 21,
      price: 39.99,
      salePrice: 37.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage47,
      stock: 21,
      price: 39.99,
      productType: 'ProductType.single',
      categoryId: '11',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage48,
      stock: 21,
      price: 59.99,
      salePrice: 52.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage49a,
      images: [ZImages.productImage49b],
      stock: 21,
      price: 89.99,
      salePrice: 84.99,
      productType: 'ProductType.variable',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage50,
      stock: 21,
      price: 499.99,
      salePrice: 456.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage51,
      stock: 21,
      price: 599.99,
      salePrice: 576.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage52,
      stock: 21,
      price: 89.99,
      salePrice: 75.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage53,
      stock: 21,
      price: 399.99,
      salePrice: 376.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage54,
      stock: 2,
      price: 60,
      productType: 'ProductType.single',
      categoryId: '17',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage55,
      stock: 2,
      price: 299.99,
      salePrice: 275.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage56,
      stock: 2,
      price: 180,
      salePrice: 177,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage57,
      stock: 2,
      price: 49,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage58,
      stock: 2,
      price: 799.99,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage59,
      stock: 2,
      price: 1299,
      salePrice: 743.99,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage60,
      stock: 2,
      price: 999,
      productType: 'ProductType.single',
      categoryId: '20',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage61,
      stock: 2,
      price: 129,
      salePrice: 127,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage62,
      stock: 2,
      price: 259,
      productType: 'ProductType.single',
      categoryId: '21',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage63,
      stock: 2,
      price: 249,
      salePrice: 212,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage64,
      stock: 2,
      price: 155,
      salePrice: 128,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage65,
      stock: 2,
      price: 620,
      salePrice: 615,
      productType: 'ProductType.single',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage66,
      stock: 2,
      price: 15,
      productType: 'ProductType.single',
      categoryId: '8',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage67a,
      images: [ZImages.productImage67b, ZImages.productImage67c],
      stock: 2,
      price: 8,
      productType: 'ProductType.variable',
      categoryId: '7',
    ...
    ProductModel(
      ...
      thumbnail: ZImages.productImage68,
      stock: 2,
      price: 27,
      productType: 'ProductType.single',
      categoryId: '9',
